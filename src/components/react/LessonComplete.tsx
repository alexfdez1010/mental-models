...
export function LessonComplete({
  ...
  return (
    <section
      aria-live="polite"
      className={cx(
        'brutal-lg mt-12 flex flex-col items-start gap-3 p-5 transition-colors sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:p-6',
        isFinished ? 'bg-brand-50/60' : 'bg-surface',
        className,
      )}
    >
